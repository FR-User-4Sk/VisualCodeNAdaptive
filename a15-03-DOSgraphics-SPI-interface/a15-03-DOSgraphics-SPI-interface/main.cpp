...
int mySPIFunction(HWND hWind, HDC hDC, int origin_x, int origin_y, int address, int* MOSI_data, int* MISO_data);
...
int main(void)
{
	...
	char chComm[16];
	int spi_address = 0xaa; //spi 주소 0xaa
	int spi_MOSI_data = 0x55; //mosi 0x55
	int spi_MISO_data = 0x55; //miso 0x55
